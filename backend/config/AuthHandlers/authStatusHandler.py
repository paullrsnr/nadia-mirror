...
"""Enum : handler de statut d'authentification par provider."""
...
class AuthStatusHandler(Enum):
    """Enum : provider → handler de statut d'auth."""
    ...
    @classmethod
    def register(cls, provider_value: str, handler: Callable):
