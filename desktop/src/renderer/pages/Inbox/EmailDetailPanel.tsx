    ...
    <div className="email-detail">
      <div className="email-detail__header">
        <div className="email-detail__header-top">
          ...
          <div className="email-detail__icon-actions">
            ...
            <button type="button" className="email-detail__icon-btn" title="Répondre">
              <IconReply />
            </button>
            <button type="button" className="email-detail__icon-btn" title="Transférer">
              <IconForward />
            </button>
      ...
      {nadiaOpen ? (
        ...
        <div className="email-detail__content">
          ...
          {(summary || draft || email.draft_reply || drafting) && (
